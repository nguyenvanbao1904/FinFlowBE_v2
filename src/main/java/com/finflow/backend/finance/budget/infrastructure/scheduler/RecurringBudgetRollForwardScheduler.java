...
import com.finflow.backend.finance.budget.application.usecase.RollRecurringBudgetsUseCase;
...
public class RecurringBudgetRollForwardScheduler {
    ...
    private final RollRecurringBudgetsUseCase rollRecurringBudgetsUseCase;
    ...
    public void rollRecurringBudgets() {
        ...
        try {
            rollRecurringBudgetsUseCase.execute();
        } catch (Exception e) {
