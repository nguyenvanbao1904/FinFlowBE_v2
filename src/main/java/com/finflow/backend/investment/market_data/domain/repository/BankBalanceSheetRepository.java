...
public interface BankBalanceSheetRepository extends JpaRepository<BankBalanceSheet, UUID> {
    ...
    List<BankBalanceSheet> findByCompanyIdOrderByYearAscQuarterAsc(String companyId);

    List<BankBalanceSheet> findByCompanyIdOrderByYearDescQuarterDesc(String companyId, Pageable pageable);
}
